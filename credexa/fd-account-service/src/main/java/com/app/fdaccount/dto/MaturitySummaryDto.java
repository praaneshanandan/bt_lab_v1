...
/**
 * DTO for Maturity Summary Report
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Maturity Summary - Accounts maturing in date range")
public class MaturitySummaryDto {
    ...
    @Schema(description = "Interest accrued", example = "7500.00")
    ...
    @Schema(description = "Maturity instruction", example = "AUTO_RENEW")
